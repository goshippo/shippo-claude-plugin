...
> **Canonical source: [`goshippo/ai`](https://github.com/goshippo/ai) (`providers/claude/plugin`).** This repository mirrors that plugin for the Claude plugin directory listing. Edit the plugin in `goshippo/ai`; this mirror is kept in sync.
...
For local development against a checkout, point Claude Code at the plugin directory instead: `claude --plugin-dir .` (the plugin root is this repository root).
